...
public class LoaderClass {
	...
	public RawModel loaadToVao(float[] positions, float[] textureCoords, float[] normals, int[] indicies) {
		int vaoID = createVAO();
	...
	private void storeDataInAttributeList(int attributeNumber, int coordinateSize, float[] data) {
		...
		FloatBuffer buffer = storedataInFlaotBuffer(data);
	...
	private FloatBuffer storedataInFlaotBuffer(float[] data) {
