...
public class OBJLoaderClass {

	public static RawModel loadOBJModel(String fileName, LoaderClass loader) {
		FileReader fr = null;
		try {
			fr = new FileReader(new File("res/" + fileName + ".obj"));
		} catch (FileNotFoundException e) {
			System.err.println("COULD'NT LOAD FILE");
			e.printStackTrace();
		}
		...
		try {
			...
			System.err.println("COULD'NT PARSE OBJECT");
		}
		...
		return loader.loaadToVao(verticiesArray, textureArray, normalsArray, indiciesArray);
	}
